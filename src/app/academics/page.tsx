...
export default function AcademicsPage() {
  return (
    <div className="flex flex-col w-full">
      ...
      {/* Section 5 */}
      <section className="sm:max-h-[600px] md:my-24 xl:my-32 xl:mb-0 mb-20 flex items-center justify-center px-4 sm:px-6">
      ...
      {/* Section 6 */}
      <section className="sm:max-h-[600px] md:my-24 lg:my-32 xl:mb-0 mb-20 flex items-center justify-center px-4 sm:px-6">
