  ...
  return (
    <div className='bg-transparent w-full min-h-screen flex flex-col items-center justify-center space-y-4 sm:space-y-8 relative'>
      ...
      <div className="w-full text-center">
        <span className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-extrabold text-black dark:text-white">Featured <span className='text-yellow-400'>Programs</span> </span>
      </div>
